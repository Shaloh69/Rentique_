...
# Create social media icons as SVG

# Facebook Icon
cat > "images/facebook-icon.png" << 'EOF'
...
# Instagram Icon
cat > "images/instagram-icon.png" << 'EOF'
<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <rect width="24" height="24" fill="white"/>
  <defs>
...
# Twitter Icon
cat > "images/twitter-icon.png" << 'EOF'
<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <rect width="24" height="24" fill="white"/>
...
# TikTok Icon
cat > "images/tiktok-icon.png" << 'EOF'
<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <rect width="24" height="24" fill="white"/>
...
echo "Social media icons created successfully!"
